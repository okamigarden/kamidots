...
def save_cRecords(lst):
    ...
    with open(r"/home/fabian/Documents/University/customerList.txt", "w") as records: # with statement makes sure the file is closed properly after writing instead of records.close()
        for customer in lst:
...
def read_customerRecords(data_file):
    with open(r"/home/fabian/Documents/University/customerList.txt", "r") as cRecords:
