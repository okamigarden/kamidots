...
class Bus(Vehicle):
    ...
    def move(self):
        ...
        while True:
            if stops == stops[0]:
                print(f"The bus was at {stops[0]} and is now moving to {stops[1]}")
            elif stops == stops[1]:
                print(f"The bus was at {stops[1]} and is now moving to {stops[2]}")
            elif stops == stops[2]:
                print(f"The bus was at {stops[2]} and is now moving to {stops[3]}")
            stops += 1
