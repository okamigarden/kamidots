...
def read_customerRecords(data_file):
    try:
        with open(data_file, "r") as cRecords:
            line = cRecords.readline()
            while line != "":
                print(line)
                line = cRecords.readline()
    except FileNotFoundError:
        print(f"The File {data_file}, could not be found. (READ COMMENTS BELOW)")

read_customerRecords("/home/fabian/Documents/Univesity/customerList.txt") # Comment this line for ASSESSMENT.
                                                                          # I use Linux so I have to specify the file directory.
#read_customerRecords("customerList.txt") # Uncomment this one 
