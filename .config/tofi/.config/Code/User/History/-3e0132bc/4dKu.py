...
class Bus(Vehicle):
    ...
    def move(self):
        ...
        if self.__current_stop < len(stops) - 1:
    ...
    def get_route(self):
        stops = ["New Street", "Bullring", "Moor Street", "BCU"]
        return f"Stops: {stops[0]} - {stops[1]} - {stops[2]} - {stops[3]}"
...
bus1.move() # New Street to Bullring
bus1.move() # Bullring to Moor Street
bus1.move() # Moor Street to BCU
bus1.move() # BCU to <none>
print(bus1.stop())